...
export default function AdvancedPerformanceCharts({ data }: AdvancedPerformanceChartsProps) {
  ...
  const advancedTimelineData = [
    ...
    { time: 1000, cpu: 85, memory: 68, network: 15, wasm: 45, webgl: 0, gpu: 45 }, // WASM compile start
    { time: 1200, cpu: 92, memory: 75, network: 10, wasm: 78, webgl: 0, gpu: 55 },
    { time: 1400, cpu: 88, memory: 82, network: 5, wasm: 65, webgl: 0, gpu: 65 },
    { time: 1600, cpu: 75, memory: 85, network: 8, wasm: 35, webgl: 25, gpu: 75 }, // GLB loading starts
    { time: 1800, cpu: 68, memory: 88, network: 12, wasm: 25, webgl: 45, gpu: 85 },
    { time: 2000, cpu: 55, memory: 92, network: 15, wasm: 15, webgl: 65, gpu: 92 },
    { time: 2200, cpu: 45, memory: 95, network: 8, wasm: 10, webgl: 78, gpu: 88 },
    { time: 2400, cpu: 35, memory: 88, network: 5, wasm: 5, webgl: 65, gpu: 75 },
    { time: 2600, cpu: 25, memory: 82, network: 3, wasm: 2, webgl: 45, gpu: 55 },
    { time: 2800, cpu: 20, memory: 75, network: 2, wasm: 0, webgl: 25, gpu: 35 },
    { time: 3000, cpu: 15, memory: 68, network: 1, wasm: 0, webgl: 15, gpu: 25 },
  ]
        ...
        <CardContent>
          ...
          >
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={advancedTimelineData}>
          ...
          <CardContent>
            <ChartContainer
              config={{
                ...
                instantiateTime: { label: "Instantiate Time (ms)", color: "#10b981" },
              }}
              className="h-[200px] sm:h-[300px]"
            >
              <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        ...
        <CardContent>
          <div className="space-y-2 max-h-[400px] overflow-y-auto">
            {networkWaterfallData.map((req, index) => (
