  ...
  const issues: Issue[] = [
    {
      ...
      category: "JavaScript",
      description:
        "Main JavaScript bundle is 280KB, causing slow initial load times",
    ...
    },
    {
      ...
      category: "Layout",
      description:
        "Elements shifting during page load causing poor user experience",
    ...
    },
    {
      ...
      category: "JavaScript",
      description:
        "JavaScript execution blocking the main thread for extended periods",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Distribution of performance issues across different categories
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete list of identified performance issues with impact
            assessment
          </CardDescription>
        </CardHeader>
        <CardContent>
